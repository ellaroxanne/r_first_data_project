...
First, let's take a look at the Region column. 
...
What about the ALPHA variable? Should that be a factor? 

<!-- Textbox. Basically no, because it's not categorical, even though it's a character vector. --> 
