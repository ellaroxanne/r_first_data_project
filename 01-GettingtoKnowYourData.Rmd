...
Right now, the data is stored in a csv file. Csv stands for "comma-separated values." R, and many other computer programs, does a good job at organizing a csv file into a dataframe, which is similar to an Excel spreadsheet or other tabular (table-like) form of organizing data. 
